      ...
      <div className="mx-auto px-4">
        <div className="flex items-center justify-between">
          ...
          <motion.button
            ...
            className="md:hidden p-2 rounded-lg bg-lime-500/20 text-lime-400 shadow-md"
          >
        ...
        {isOpen && (
          <motion.div
            ...
            className="md:hidden mt-6 bg-gray-900/90 backdrop-blur-md shadow-lg rounded-2xl p-6"
          >
            <div className="flex flex-col space-y-4">
              {navItems.map((item) => (
                <motion.a
                  ...
                  className="text-white hover:text-lime-400 transition-colors font-medium py-2"
                >
                  {item.label}
                </motion.a>
              ))}
              <div className="pt-4 border-t border-gray-700 space-y-3">
                <button
                  onClick={handleResumeBtn}
                  className="w-full flex items-center justify-center px-4 py-2 rounded-lg border border-lime-400 text-lime-400 hover:bg-lime-500/20 space-x-2 transition"
                >
                  <Download size={16} />
