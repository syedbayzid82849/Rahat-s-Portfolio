                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        {navItems.map((item) => (
                            <motion.a
                                ...
                                href={item.href}
                                whileHover={{ y: -2 }}
                                className="text-gray-800 hover:text-indigo-500 transition-colors font-medium"
                            >
                                {item.label}
                            </motion.a>
                        ))}
                    ...
                    <div className="hidden md:flex items-center space-x-4">
                        ...
                        <motion.button
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                            className="flex items-center space-x-2 bg-gradient-to-r from-purple-600 to-blue-600 text-white font-semibold py-4 px-8 rounded-full shadow-lg transition-all duration-300 transform hover:scale-105 hover:shadow-xl"
                        >
