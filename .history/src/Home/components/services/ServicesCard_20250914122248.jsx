...
const ServicesCard = ({ service }) => {
    ...
    return (
        <motion.div
            className="bg-gray-800 shadow-lg rounded-2xl p-6 group hover:shadow-2xl hover:shadow-green-600 transition duration-300"
        ...
        >
            ...
            <p className="text-sm mt-2 line-clamp-2 ove">{service.description}</p>
