                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                {contactInfo.map((info, index) => (
                                    <motion.div key={info.title} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: index * 0.1 }} viewport={{ once: fal }} className="flex items-center space-x-4 p-4 glass rounded-xl hover:shadow-glow transition-all duration-300">
