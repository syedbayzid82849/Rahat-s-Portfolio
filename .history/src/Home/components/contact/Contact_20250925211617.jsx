...
const About = () => {
    ...
    const softSkills = [
        ...
        },
        {
            ...
            icon: (
                <path d="M12 20c4.41 0 8-3.59 
        8-8s-3.59-8-8-8-8 3.59-8 
        8 3.59 8 8 
        8zm.5-13h-1v6l5.25 
        3.15.75-1.23-5-2.92V7z" />
            ),
        },
        {
            title: "Creativity",
        ...
        },
        {
            ...
            icon: (
                <path d="M11.99 2C6.47 2 2 
        6.48 2 12s4.47 10 9.99 10C17.52 
        22 22 17.52 22 12S17.52 2 11.99 
        2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 
        8-8 8 3.58 8 8-3.58 8-8 
        8zm3.5-9c.83 0 1.5-.67 
        1.5-1.5S16.33 8 15.5 8 14 
        8.67 14 9.5s.67 1.5 1.5 
        1.5zm-7 0c.83 0 1.5-.67 
        1.5-1.5S9.33 8 8.5 8 7 
        8.67 7 9.5 7.67 11 8.5 
        11zm3.5 6.5c2.33 0 4.31-1.46 
        5.11-3.5H6.89c.8 2.04 2.78 
        3.5 5.11 3.5z" />
            ),
        },
        {
            ...
            icon: (
                <path d="M12 7V3H2v18h20V7H12zM4 
        19V5h6v2H6v2h4v2H6v2h4v2H6v2h4v2H4zm16 
        0h-8v-8h8v8z" />
            ),
        },
        {
        ...
        2 12s4.48 10 10 10c1.85 0 
        3.58-.51 5.05-1.39L21 
        22l-1.39-3.95A9.96 9.96 0 
