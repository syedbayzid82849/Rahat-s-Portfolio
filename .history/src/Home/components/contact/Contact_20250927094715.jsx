                        ...
                        <div className="glass rounded-3xl p-4">
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <select id="subject" className="w-full text-black px-4 py-3 rounded-xl bg-transparent border border-border focus:border-primary focus:ring-2 focus:ring-primary/20 text-foreground"
                                        {...register("subject", { required: "Please select a service" })}>
                                        <option value="">Select a service</option>
                                        {services.map((service, i) => <option className='' key={i} value={service}>{service}</option>)}
                                    </select>
