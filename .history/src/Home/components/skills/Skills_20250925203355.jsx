...
const Skills = () => {
    ...
    const skills = [
        ...
        { name: "Brand Identity Design", percent: "92%", color: "from-yellow-500 to-orange-500" },
                ...
                <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    {expertise.map((item, index) => (
                        ...
                        >
                            ...
                            <span className="text-gray-100 font-medium group-hover:text-green-400 transition-colors">
                                {item.name}
                            </span>
                        </motion.div>
                    ))}
