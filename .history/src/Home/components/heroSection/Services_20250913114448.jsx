...
import { Star, ArrowRight, Linkedin, Instagram, Palette, CreditCard, Youtube } from "lucide-react";
...
const services = [
    { icon: <Palette className="w-8 h-8" />, title: "Graphic Design" },
    { icon: <Palette className="w-8 h-8" />, title: "Logo Design" },
    { icon: <Palette className="w-8 h-8" />, title: "Presentation Design" },
    { icon: <Palette className="w-8 h-8" />, title: "Packaging Design" },
    { icon: <Palette className="w-8 h-8" />, title: "Print Design" },
    { icon: <Palette className="w-8 h-8" />, title: "Brand Design" },
    { icon: <Palette className="w-8 h-8" />, title: "Visual Design" },
    { icon: <Palette className="w-8 h-8" />, title: "Ad Design" },
    { icon: <Palette className="w-8 h-8" />, title: "Industrial Design" },
    { icon: <Palette className="w-8 h-8" />, title: "WordPress Design" },
];
                    ...
                    {services.map((service, index) => (
                        ...
                        >
                            ...
                            <div className="space-y-3 text-white">
                                ...
                                <p className="text-gray-300 text-sm">Professional {service.title.toLowerCase()} services to elevate your brand.</p>
                            </div>
