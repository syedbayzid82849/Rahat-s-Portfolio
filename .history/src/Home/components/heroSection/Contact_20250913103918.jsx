...
const Contact = () => {
    ...
    const contactInfo = [
        { icon: <Mail className="w-6 h-6" />, title: "Email", value: "rahatfigure10@gmail.com", link: "mailto:rahat@example.com" },
        { icon: <Phone className="w-6 h-6" />, title: "Phone", value: "+8801722853978", link: "tel:+8801722853978" },
