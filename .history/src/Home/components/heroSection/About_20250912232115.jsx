            ...
            <section id="about" className="py-15 ">
                <div className="container mx-auto px-6">
                    ...
                    >
                        ...
                        <p className="text-xl text-gray-00 max-w-3xl mx-auto">
                            A passionate creative professional dedicated to helping brands tell their story
                            through compelling visual design and strategic branding solutions.
                        </p>
                    </motion.div>
