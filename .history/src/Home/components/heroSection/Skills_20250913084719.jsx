            ...
            <div className="container mx-auto px-6">
                ...
                >
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        {['Photoshop', 'Illustrator', 'InDesign', 'Figma', 'Canva', 'After Effects'].map((tool, index) => (
                            <motion.div
                                key={tool}
                                ...
                                viewport={{ once: true }}
                                className="glass px-6 py-3 rounded-full font-medium text-foreground border border-primary/20 hover:bg-primary/10 transition-colors"
                            >
                                {tool}
                            </motion.div>
                        ))}
