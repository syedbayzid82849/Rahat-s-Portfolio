                ...
                <div className="container mx-auto px-6">
                    ...
                    >
                        ...
                        <div className="grid md:grid-cols-3 gap-6 mt-12">
                            <div className="flex flex-col items-center space-y-3 p-6 glass rounded-2xl hover:shadow-lg transition border border-[#f0f0f0] hover:border-primary">
                            ...
                            <div className="flex flex-col items-center space-y-3 p-6 glass rounded-2xl hover:shadow-lg transition">
