...
const Hero = () => {
    ...
    const statsData = [
        { label: 'Projects', endValue: 500, duration: 3, suffix: '+' },
        { label: 'Happy Clients', endValue: 50, duration: 3, suffix: '+' },
        { label: 'Years Experience', endValue: 5, duration: 3, suffix: '+' }, // New 'Experience' stat
    ];
