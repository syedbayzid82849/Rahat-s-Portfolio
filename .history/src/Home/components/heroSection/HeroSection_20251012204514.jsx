...
const Hero = () => {
    ...
    const statsData = [
        { label: 'Projects', endValue: 1, duration: 2, suffix: '+' },
    ...
    return (
        <>
            ...
            >
                                ...
                                {statsData.map((stat, index) => (
                                    <React.Fragment key={stat.label}>
                                        ...
                                        {index < statsData.length - 1 && (
                                            <div className=" sm:block h-20 w-px bg-white/50 mx-4 lg:mx-8"></div>
                                        )}
                                    </React.Fragment>
                                ))}
                            </motion.div>
                            ...
                            >
                                ...
                                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                                    <Button
                                        size="lg"
                                        variant="outline"
                                        className="border-green-500 text-white hover:bg-green-700 hover:text-black transition-all duration-300"
                                    >
                                        <a
                ...
                {/* Back to top button */}
                {scrolled && (
                    <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }} className="fixed bottom-8 right-4 z-50">
                        <Button
                            onClick={scrollToTop}
                            size="icon"
                            variant="outline"
                            className="rounded-full glass border-green-500 bg-card/50 hover:bg-green-100 hover:shadow-[0_0_15px_4px_rgba(34,197,94,0.6)]transition-all duration-300"
                        >
                            <ArrowUp size={16} />
                        </Button>
                    </motion.div>
