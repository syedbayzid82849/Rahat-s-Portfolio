...
import { Star, ArrowRight, Palette, Wordpress } from "lucide-react";
...
const WordpressIcon = () => (
    <svg width="32" height="32" viewBox="0 0 512 512" fill="currentColor">
        <path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8zm0 96c42 0 76 34 76 76s-34 76-76 76-76-34-76-76 34-76 76-76z" />
    </svg>
);

// Services Data with Features
const services = [
    {
