...
const Hero = () => {
    return (
        <>
            ...
            <section id="home" className="max-w-7xl min-h-screen mx-auto flex items-center relative overflow-hidden mt-14 md:mt-0 lg:mt-8 border">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <motion.div
                            ...
                            className="relative flex justify-center mt-"
                        >
