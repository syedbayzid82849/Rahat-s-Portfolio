...
const Contact = () => {
    ...
    const contactInfo = [
        { icon: <Mail className="w-6 h-6" />, title: "Email", value: "rahat@example.com", link: "mailto:rahat@example.com" },
        { icon: <Phone className="w-6 h-6" />, title: "Phone", value: "+1 (555) 123-4567", link: "tel:+15551234567" },
        { icon: <MapPin className="w-6 h-6" />, title: "Location", value: "Available Worldwide", link: null }
    ];

    const socialLinks = [
        { icon: <Linkedin className="w-5 h-5" />, name: "LinkedIn", url: "hthttps://www.linkedin.com/in/rgxfigure/", color: "hover:text-primary" },
            ...
            <div className="container mx-auto px-6">
                ...
                <div className="grid lg:grid-cols-2 gap-16">
                        ...
                        <div className="glass rounded-3xl p-8">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <select id="subject" name="subject" value={formData.subject} onChange={handleChange} required className="w-full px-4 py-3 rounded-xl bg-surface border border-border focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all duration-300 text-foreground">
                    ...
                    <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }} className="space-y-8">
                        ...
                        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }} className="glass rounded-3xl p-8 bg-gradient-primary text-primary-foreground">
                            <h4 className="text-xl font-bold mb-4">Ready to Start?</h4>
                            <p className="mb-6 opacity-90">I typically respond within 24 hours and offer free consultations for all new projects. Let's discuss your vision!</p>
                            <div className="space-y-2 text-sm opacity-80">
                                <p>✅ Free initial consultation</p>
                                <p>✅ Custom project quotes</p>
