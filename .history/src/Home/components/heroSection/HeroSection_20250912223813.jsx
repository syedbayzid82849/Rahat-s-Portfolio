...
const Hero = () => {
    return (
        <>
            ...
            <section id="home" className="max-w-7xl min-h-screen mx-auto flex items-center relative overflow-hidden mt-14 md:mt-0 lg:mt-7 border">
                        ...
                        >
                            ...
                            >
                                <h1 className="text-5xl md:text-7xl font-bold leading-tight">
                                    <span className="text-purple-600">RAgat</span><br />
                                    <span className="text-gray-400">Design</span><br />
