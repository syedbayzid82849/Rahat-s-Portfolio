...
import {
    ...
    CreditCard, Zap, Heart, Award, Video
} from 'lucide-react';
import { Brush, Layout, Monitor, Layers,  } from "lucide-react";
...
const Skills = () => {
    ...
    const tools = [
        ...
        { name: "Illustrator", icon: <Brush className="w-5 h-5" /> },
        { name: "InDesign", icon: <Layout className="w-5 h-5" /> },
        { name: "Figma", icon: <Monitor className="w-5 h-5" /> },
        { name: "Canva", icon: <Layers className="w-5 h-5" /> },
        { name: "After Effects", icon: <Video className="w-5 h-5" /> },
    ];
