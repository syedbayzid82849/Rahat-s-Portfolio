...
const Hero = () => {
    return (
        <>
            ...
            <section id="home" className=" min-h-screen flex items-center relative overflow-hidden mt-14 md:mt-0 lg:mt-7 border">
                ...
                <div className="container mx-auto px lg:px-6 relative z-10">
