            ...
            <div className="container mx-auto">
                ...
                <Marquee gradient={false} speed={60}>
                    <div className="flex gap-10 items-center">
                        <img src="" alt="Google" className="h-24" />
                        <img src="" alt="Apple" className="h-24" />
                        <img src="" alt="Microsoft" className="h-24" />
                        <img src="" alt="Amazon" className="h-24" />
                        <img src="" alt="Facebook" className="h-24" />
                        <img src="" alt="Netflix" className="h-24" />
                        <img src="" alt="Tesla" className="h-24" />
                        <img src="" alt="Nike" className="h-24" />
                    </div>
                </Marquee>
            </div>
        </section>
