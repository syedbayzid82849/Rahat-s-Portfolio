        ...
        <section className="py-20 border-t border-gray-700">
            ...
            <Marquee gradient={false} speed={50}>
                <div className="flex gap-10 items-center">
                    ...
                    <img src="https://upload.wikimedia.org/wikipedia/fr/c/c8/Twitter_Bird.svg" alt="Twitter" className="h-12" />
                    ...
                    <img src="https://upload.wikimedia.org/wikipedia/commons/d/d7/Adobe_Systems_logo_and_wordmark.svg" alt="Adobe" className="h-12" />
                    <img src="https://commons.wikimedia.org/wiki/File:Samsung_old_logo_before_year_2015.svg" alt="Samsung" className="h-12" />
                    <img src="https://upload.wikimedia.org/wikipedia/commons/c/c9/Intel-logo.svg" alt="Intel" className="h-12" />
                </div>
            </Marquee>
        </section>
    );
