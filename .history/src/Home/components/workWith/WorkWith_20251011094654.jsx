            ...
            <div className="container mx-auto">
                ...
                <Marquee gradient={false} speed={60}>
                    <div className="flex gap-10 items-center">
                        ...
                        <img srcdddddddddddddddddddddddd="/assets/comp5.png" alt="MY LETTERS (ML)" className="h-28" />
                        ...
                        <img src="/assets/comp12.png" alt="TRIPEL" className="h-28" />
                        ...
                        <img src="/assets/comp16.png" alt="Unidentified Logo" className="h-28" />
                    </div>
                </Marquee>
            </div>
        </section>
