            ...
            <div className="container mx-auto">
                ...
                <Marquee gradient={false} speed={60}>
                    <div className="flex gap-10 items-center">
                        ...
                        <img src={company2} alt="Apple" className="h-24" />
                        <img src={company3} alt="Microsoft" className="h-24" />
                        <img src={company4} alt="Amazon" className="h-24" />
                        <img src={company5} alt="Facebook" className="h-24" />
                        <img src={company6} alt="Netflix" className="h-24" />
                        <img src={company7} alt="Tesla" className="h-24" />
                        <img src={company8} alt="Nike" className="h-24" />
                    </div>
                </Marquee>
            </div>
        </section>
