...
const HeroSection = () => {
    return (
        <section className="text-center py-16 bg-gradient-to-br from-purple-100 via-white to-yellow-100 flex justify-between items-center flex-col md:flex-row gap-8">
