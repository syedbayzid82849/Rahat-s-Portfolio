    ...
    return (
        <section className="max-w-7xl mx-auto border min-h-screen flex justify-around items-center flex-col md:flex-row gap-8">
            <div className='w-2/3 border-2'>
                ...
                <p className=" text-gray-600 max-w-xl">I’m a Professional Graphic Designer with experience in branding, logo, and social media design. I’ve worked with 5+ clients remotely.</p>
