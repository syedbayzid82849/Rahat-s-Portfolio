...
const HeroSection = () => {
    return (
        <section className="min-h-screen py-16 bg-gradient-to-br from-purple-100 via-white to-yellow-100 flex justify-around items-center flex-col md:flex-row gap-8">
