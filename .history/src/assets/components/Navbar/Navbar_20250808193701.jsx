...
const Navbar = () => {
    ...
    return (
        <nav className="bg-white shadow-sm">
            <div className="max-w-7xl mx-auto px-4 flex justify-between items-center h-16">
                ...
                <div className="hidden lg:flex space-x-6">
                    ...
                    <div className="group relative">
                        <button className="tlg:hidden bg-white shadow-md border-t px-4 py-4 space-y-2ext-gray-700 hover:text-indigo-600">Parent</button>
            ...
            {isOpen && (
                <div className="lg:hidden bg-white shadow-md border-t px-4 py-4 space-y-2">
