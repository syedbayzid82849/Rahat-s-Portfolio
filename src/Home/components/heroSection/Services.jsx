...
import { User, Linkedin, Instagram, Palette, CreditCard, Youtube, Star, ArrowRight } from 'lucide-react';
            ...
            <div className="container mx-auto px-6">
                ...
                text-white group-hover:scale-110 transition-transform duration-300`}>
                            ...
                            <div className="mt-6 pt-4 border-t border-gray-700 flex items-center justify-between">
                                <div>
                                    <div className="text-lg font-bold text-gradient bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 bg-clip-text text-transparent">{service.price}</div>
                                    <div className="text-xs text-gray-400">Custom quotes available</div>
                                </div>
                                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                                    <Button variant="outline" size="sm" className="border-white/20 hover:bg-white/10 flex items-center space-x-1">
